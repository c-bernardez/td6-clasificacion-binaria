...
```  
    ...
    'scaly', 'movable', 'none', 'unknown'] #unknown?
```
...
ggplot(results, aes(x = minsplit_val, y = auc)) +
  ...
  scale_shape_manual(values = c(15, 16, 17, 18, 10)) +  # Custom shapes for better visibility
  scale_color_brewer(palette = "Set1") +  # Customize colors to highlight maxdepth 9
  scale_y_continuous(breaks = seq(0.45, 0.9, by = 0.05), 
                     labels = function(x) format(x, nsmall = 2)) +  # Custom labels for y-axis
