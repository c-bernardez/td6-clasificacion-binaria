...
* Los arboles logran capturar interacciones entre variables, como color y forma del sombrero.
...
Para resumir, la variable \texttt{class} es una variable categórica binaria que indica si un hongo es comestible (\texttt{edible}) o venenoso (\texttt{poisonous}) para poder hacer una clasificación binaria. 
