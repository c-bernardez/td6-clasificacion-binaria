...
indices <- sample(1:n) #tomamos indices aleatorios, es decir filas aleatorias, para luego solo tomar del 1-70% de esos indices (ya sabemos que no son filas ordenadas), del 70-85% y del 85-100%
